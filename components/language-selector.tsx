...
export function BrazilFlagIcon({ className, ...props }: FlagIconProps) {
  return (
    <svg
      className={className}
...
function SpainFlagIcon({ className, ...props }: FlagIconProps) {
  return (
    ...
    >
      ...
      <path
        fill="#ad1519"
        d="M144 304c0 26.5-21.5 48-48 48s-48-21.5-48-48 21.5-48 48-48 48 21.5 48 48z"
      />
      <path
        fill="#c60b1e"
        d="M128 304c0 17.7-14.3 32-32 32s-32-14.3-32-32 14.3-32 32-32 32 14.3 32 32z"
      />
      <path
        fill="#ffc400"
        d="M96 288c0 8.8-7.2 16-16 16s-16-7.2-16-16 7.2-16 16-16 16 7.2 16 16z"
      />
    </svg>
  );
}
