...
export default function HeroSection() {
  ...
  const scrollToContent = () => {
    const nextSection =
      ...
      document.getElementById("topicos-principais");
    if (nextSection) {
  ...
  const datasImportantes = [
    {
      data: t("data_1"),
      titulo: t("submissao_de_artigos"),
      icone: <Send className="h-4 w-4" />,
    },
    {
      data: t("data_2"),
      titulo: t("comunicacao_de_aceite"),
      icone: <CheckCircle className="h-4 w-4" />,
    },
    {
      data: t("data_3"),
      titulo: t("envio_final"),
      icone: <Clock className="h-4 w-4" />,
    },
    {
      data: t("data_4"),
      titulo: t("realizacao_do_evento"),
                ...
                >
                  ...
                  <div className="bg-blue-800/50 backdrop-blur-sm p-5 rounded-xl mb-8 border border-blue-700/50 shadow-lg">
                    <div className="flex items-center mb-4">
                      ...
                      <span className="text-blue-50 text-base md:text-xl">
                        {t("date")}
                      </span>
                    </div>
                    <div className="flex items-center">
                ...
                >
                  ...
                  <div className="space-y-3">
                    {datasImportantes.map((data, index) => (
                      <div
                        key={index}
                        className="flex items-center bg-blue-800/70 rounded-lg p-3"
                      >
                        <div className="bg-blue-700/70 p-2 rounded-full mr-3">
                          {data.icone}
                        </div>
                        <div>
